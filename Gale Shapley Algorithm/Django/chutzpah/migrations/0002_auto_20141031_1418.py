    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(verbose_name='owner', related_name='programmes', to=settings.AUTH_USER_MODEL)),
            ],
            options={
